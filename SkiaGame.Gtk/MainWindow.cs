...
public class MainWindow : Window
{
    ...
    {
        TranslateCoordinates(Child, (int)eventButton.XRoot,
            (int)eventButton.YRoot,
    ...
    {
        if (_engine.Mouse.MouseState.ContainsKey(
                (MouseButton)args.Event.Button) &&
            _engine.Mouse.MouseState[(MouseButton)args.Event.Button]
                .IsPressed) return;
    ...
    private void SkiaViewOnPaintSurface(object? sender,
