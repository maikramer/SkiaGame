...
namespace SkiaGame.UI
{
    ...
    public class NotifiableStyle : BaseModel, IStyle, ICloneable
    {
        ...
        /// </summary>
        public NotifiableStyle() { FromSkTypeFace(SKTypeface.Default); }
        ...
        public SKColor HaloColor { get => _haloColor; set => SetProperty(ref _haloColor, value); }

        public float HaloWidth { get => _haloWidth; set => SetProperty(ref _haloWidth, value); }

        public float HaloBlur { get => _haloBlur; set => SetProperty(ref _haloBlur, value); }
        ...
        {
            var style = new NotifiableStyle { FontFamily = fontFamily };
